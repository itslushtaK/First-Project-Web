    ...
    if(isset($email) && !empty($email) && isset($password) && !empty($password) && isset($confirm_password) && !empty($confirm_password) ) {
        ...
        // if(filter_var($email, FILTER_VALIDATE_EMAIL)) {
            if(is_password($password)) {
                ...
                $errors[] = "Passwordi duhet te kete se paku nje shkronje te madhe dhe nje specialChar (# *)";
            }
        } else {
...
<div class="banner">
    ...
    <h2 style="text-align:center; color:white;" >Shto Userin</h2>
    <?php
        echo "<ul>"; 
        if(count($errors)) {
...
<div class="password">
    ...
    <p style="text-align:center;">Confrim Password</p>
    <div class="password">
        <input type="password"  name="confirm_password" placeholder="Konfirmo passwordin" >
        <br /><br />
    </div>
<div class="password">
    <button  type="submit" name="submit_btn"><span></span>Shto Userin</buton>
    </div>      
